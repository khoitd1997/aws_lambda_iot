...
class AWSIoTMQTTClient:
    ...
    def __init__(self, clientID, protocolType=MQTTv3_1_1, useWebsocket=False, cleanSession=True):
        ...
        **Returns**
        ...
        """
        self._mqtt_core = MqttCore(
            clientID, cleanSession, protocolType, useWebsocket)
    ...
    # Should be good for MutualAuth certs config and Websocket rootCA config
    ...
    def configureAutoReconnectBackoffTime(self, baseReconnectQuietTimeSecond, maxReconnectQuietTimeSecond, stableConnectionTimeSecond):
        ...
        **Returns**
        ...
        """
        self._mqtt_core.configure_reconnect_back_off(
    ...
    def configureOfflinePublishQueueing(self, queueSize, dropBehavior=DROP_NEWEST):
        ...
        **Returns**
        ...
        """
        self._mqtt_core.configure_offline_requests_queue(
            queueSize, dropBehavior)
...
class _AWSIoTMQTTDelegatingClient(object):
    ...
    def __init__(self, clientID, protocolType=MQTTv3_1_1, useWebsocket=False, cleanSession=True, awsIoTMQTTClient=None):
        ...
        **Returns**
        ...
        self._AWSIoTMQTTClient = awsIoTMQTTClient if awsIoTMQTTClient is not None else AWSIoTMQTTClient(
            clientID, protocolType, useWebsocket, cleanSession)
    ...
    def configureIAMCredentials(self, AWSAccessKeyID, AWSSecretAccessKey, AWSSTSToken=""):
        ...
        **Returns**
        ...
        self._AWSIoTMQTTClient.configureIAMCredentials(
            AWSAccessKeyID, AWSSecretAccessKey, AWSSTSToken)

    # Should be good for MutualAuth and Websocket
    def configureCredentials(self, CAFilePath, KeyPath="", CertificatePath=""):
        """
        **Description**
        ...
        **Returns**
        ...
        self._AWSIoTMQTTClient.configureCredentials(
            CAFilePath, KeyPath, CertificatePath)
...
class AWSIoTMQTTShadowClient(_AWSIoTMQTTDelegatingClient):
    ...
    def __init__(self, clientID, protocolType=MQTTv3_1_1, useWebsocket=False, cleanSession=True, awsIoTMQTTClient=None):
        ...
        **Returns**
        ...
        """
        super(AWSIoTMQTTShadowClient, self).__init__(
            clientID, protocolType, useWebsocket, cleanSession, awsIoTMQTTClient)
...
class AWSIoTMQTTThingJobsClient(_AWSIoTMQTTDelegatingClient):
    ...
    def __init__(self, clientID, thingName, QoS=0, protocolType=MQTTv3_1_1, useWebsocket=False, cleanSession=True, awsIoTMQTTClient=None):
        ...
        **Returns**
        ...
        """
        # AWSIOTMQTTClient instance
        super(AWSIoTMQTTThingJobsClient, self).__init__(
            clientID, protocolType, useWebsocket, cleanSession, awsIoTMQTTClient)
        self._thingJobManager = thingJobManager.thingJobManager(
            thingName, clientID)
        self._QoS = QoS
    ...
    def createJobSubscription(self, callback, jobExecutionType=jobExecutionTopicType.JOB_WILDCARD_TOPIC, jobReplyType=jobExecutionTopicReplyType.JOB_REQUEST_TYPE, jobId=None):
        ...
        **Returns**
        ...
        """
        topic = self._thingJobManager.getJobTopic(
            jobExecutionType, jobReplyType, jobId)
    ...
    def sendJobsQuery(self, jobExecTopicType, jobId=None):
        ...
        **Returns**
        ...
        """
        topic = self._thingJobManager.getJobTopic(
            jobExecTopicType, jobExecutionTopicReplyType.JOB_REQUEST_TYPE, jobId)
    ...
    def sendJobsStartNext(self, statusDetails=None):
        ...
        **Returns**
        ...
        """
        topic = self._thingJobManager.getJobTopic(
            jobExecutionTopicType.JOB_START_NEXT_TOPIC, jobExecutionTopicReplyType.JOB_REQUEST_TYPE)
        payload = self._thingJobManager.serializeStartNextPendingJobExecutionPayload(
            statusDetails)
        return self._AWSIoTMQTTClient.publish(topic, payload, self._QoS)
    ...
    def sendJobsUpdate(self, jobId, status, statusDetails=None, expectedVersion=0, executionNumber=0, includeJobExecutionState=False, includeJobDocument=False):
        ...
        **Returns**
        ...
        """
        topic = self._thingJobManager.getJobTopic(
            jobExecutionTopicType.JOB_UPDATE_TOPIC, jobExecutionTopicReplyType.JOB_REQUEST_TYPE, jobId)
        payload = self._thingJobManager.serializeJobExecutionUpdatePayload(
            status, statusDetails, expectedVersion, executionNumber, includeJobExecutionState, includeJobDocument)
        return self._AWSIoTMQTTClient.publish(topic, payload, self._QoS)
    ...
    def sendJobsDescribe(self, jobId, executionNumber=0, includeJobDocument=True):
        ...
        **Returns**
        ...
        """
        topic = self._thingJobManager.getJobTopic(
            jobExecutionTopicType.JOB_DESCRIBE_TOPIC, jobExecutionTopicReplyType.JOB_REQUEST_TYPE, jobId)
        payload = self._thingJobManager.serializeDescribeJobExecutionPayload(
            executionNumber, includeJobDocument)
        return self._AWSIoTMQTTClient.publish(topic, payload, self._QoS)
